    ...
    <div className="w-full max-w-[1240px] h-auto rounded-[40px] items-center m-auto py-8 bg-gray-100">
      ...
      {isMobile ? (
        ...
        <div className="grid grid-cols-1 gap-6 w-[80%] mx-auto">
          {[{ href: '/casual', img: '/images/Frame 105.png', alt: 'Casual' },
            { href: '/formal', img: '/images/Frame 106.png', alt: 'Formal' },
            { href: '/formal-style', img: '/images/Frame 107.png', alt: 'Formal Style' },
            { href: '/other-style', img: '/images/Frame 108.png', alt: 'Other Style' }]
